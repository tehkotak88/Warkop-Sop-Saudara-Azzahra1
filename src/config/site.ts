export const SITE_CONFIG = {
  brandName: 'Warkop Azzahra',
  websiteLabel: 'WWW.WARKOPAZZAHRA.COM',
  titles: {
    home: 'Warkop Azzahra - Nikmati Kopi Terbaik',
  ...
  contact: {
    ...
    address: 'Bontoa, Mandai, Maros Regency',
    addressLine2: 'South Sulawesi',
    openingHours: '08:00 - 22:00 WIB',
    openingDays: 'Senin - Minggu',
    mapsEmbedUrl:
  ...
  outlets: [
    {
      name: 'Cabang Bontoa (Maros)',
      address: 'Jl. Poros Maros - Makassar No.KM.20, Bontoa, Kec. Mandai',
      phone: '+62 852-5666-9994',
      whatsappNumber: '6285256669994',
      rating: 4.5,
      reviewCount: 159,
    ...
    {
      name: 'Cabang Gowa',
      address: 'Jl. Sultan Hasanuddin No.160, Pandang-Pandang, Kec. Somba Opu',
      phone: '+62 823-3335-5538',
      whatsappNumber: '6282333355538',
      rating: 4.2,
      reviewCount: 37,
    ...
    {
      name: 'Cabang Ujung Pandang Baru',
      address: 'Jl. Ujung Pandang Baru No.16, Ujung Pandang Baru, Kec. Tallo',
      phone: '+62 823-3335-5537',
      whatsappNumber: '6282333355537',
      rating: 4.5,
      reviewCount: 78,
    ...
    },
    {
      ...
      address: 'Pajukukang, Kec. Bontoa, Kabupaten Maros, Sulawesi Selatan',
      phone: '+62 812-2255-5217',
      whatsappNumber: '6281222555217',
      rating: 4.8,
      reviewCount: 37,
    ...
    {
      name: 'Cabang Tanjung',
      address: 'Jl. Metro Tanjung Bunga, Tanjung Merdeka, Kec. Tamalate',
      phone: '+62 822-2651-3872',
      whatsappNumber: '6282226513872',
      rating: 4.3,
      reviewCount: 75,
